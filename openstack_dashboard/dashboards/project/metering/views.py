...
class SamplesView(TemplateView):
    ...
    def _get_series_default(self, request, params):
        query = []
        ...
        try:
            resources = ceilometer_usage.resources_with_statistics(
                query, [params["meter"]], period=params["period"],
                stats_attr=None, additional_query=params["additional_query"],
